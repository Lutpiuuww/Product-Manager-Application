...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO products (name, category, price, stock, image_path) VALUES (:name, :category, :price, :stock, :image_path)");
            $stmt->execute([
                ':name' => $name,
                ':category' => $category,
                ':price' => $price,
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="create.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Gambar Produk (Opsional, Max 2MB)</label>
                    <input type="file" name="image" accept="image/jpeg, image/png, image/webp, image/gif">
                </div>
                <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 10px;">SIMPAN PRODUK</button>
            </form>
        </div>
    </div>
</body>
